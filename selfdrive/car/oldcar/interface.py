...
class CarInterface(object):
  def __init__(self, CP, sendcan=None):
    ...
    # Tap cruise on/off 2 times to enable/disable
  ...
  def get_params(candidate, fingerprint):
    ...
    ret.steerActuatorDelay = 0.16 #0.12 #camryh too quick, reduce delay gor oscillations # Default delay, Prius has larger delay
    ...
    if candidate == CAR.COROLLA:
      ...
      ret.steerRatio = 15.8 #15.6 #hand tune, actual is 14.8
