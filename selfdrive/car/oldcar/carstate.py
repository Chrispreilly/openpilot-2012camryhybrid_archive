...
class CarState(object):
  def __init__(self, CP):
    ...
    self.CL_MAX_ANGLE_DELTA = [1.8, .6] #.3]
    ...
    self.CL_LANE_PASS_TIME = [40.,10., 5.] 

    # change lane delta angles and other params
    self.CL_MAXD_BP = [10., 32., 44.]
    self.CL_MAXD_A = [.358, 0.11, 0.1572] # [.358, 0.084, 0.042]#delta angle based on speed; needs fine tune, based on Tesla steer ratio of 16.75
