...
from selfdrive.car.oldcar.values import CAR, DBC, STEER_THRESHOLD
from common.kalman.simple_kalman import KF1D
...
class CarState(object):
  def __init__(self, CP):
    ...
    #self.CL_MAX_ANGLE_DELTA_BP = [10., 32., 44.]#[10., 44.] #delete if good
    #self.CL_MAX_ANGLE_DELTA = [2.3, 1.3, 0.6]# #delete if good
    ...
    #self.CL_MAXD_A = [.358, 0.084, 0.042] #default
    self.CL_MAXD_A = [.358, 0.084, 0.072] #delta angle based on speed; needs fine tune, based on Tesla steer ratio of 16.75 #delete if good
    ...
    self.CL_TIMEA_T = [0.7 ,0.50, 0.40]# Old test -[0.7 ,0.60, 0.70]#
    #duration to wait (in seconds) with blinkers on before starting to turn
    self.CL_WAIT_BEFORE_START = 0.1 #1
    #END OF ALCA PARAMS
  ...
  def init_ui_buttons(self):
    ...
    btns.append(UIButton("alca", "ALC", 2, self.alcaLabels[self.alcaMode], 1))
